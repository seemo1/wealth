...
//id: null means it's not saved into inbox table
//workType: 0 means the type is invalid, not used
//Reference: https://docs.google.com/spreadsheets/d/1ambWKTQj2LleI5jbJU0mdYnl7ASqNxQ53jJzTu9zTEw/edit?usp=sharing

var htmlMsgKey = {
  INBOX_FOLLOW: {id: 4, str: 'FOLLOW', workType: 5, icon: 'comment', deepLink: '{0}://fdt/discover/userprofile?userid={1}&UserFollowed={2}'},
  ...
  INBOX_INVITE: {id: 10, str: 'INVITE', workType: 7, icon: 'group', deepLink: '{0}://fdt/discover/group?groupid={1}&inside=n'},
  INBOX_ACCEPTED: {id: 11, str: 'ACCEPTED', workType: 1, icon: 'group', deepLink: '{0}://fdt/discover/group?groupid={1}&inside=y'},
  INBOX_KICKED: {id: 12, str: 'KICKED', workType: 1, icon: 'group', deepLink: ''},
  ...
  INBOX_REQUESTTOJOIN: {id: 16, str: 'REQUESTTOJOIN', workType: 7, icon: 'group', deepLink: '{0}://fdt/discover/group?groupid={1}&inside=y'},
  INBOX_APPROVETOJOIN: {id: 17, str: 'APPROVETOJOIN', workType: 1, icon: 'group', deepLink: '{0}://fdt/discover/group?groupid={1}&inside=y'},
  INBOX_ECONCALENDAR: {id: 18, str: 'ECONCALENDAR', workType: 1, icon: 'bull', deepLink: ''},
  INBOX_COMMENTLIKE: {id: 19, str: 'COMMENTLIKE', workType: 1, icon: 'comment', deepLink: '{0}://fdt/timelines/post?postid={1}'},
  ...
  SCHOOL_PASS: {id: 69, str: 'SCHOOL_PASS', workType: 1, icon: 'bull', deepLink: '{0}://fdt/me/editprofile/editschool'},
  SCHOOL_REJECTED: {id: 70, str: 'SCHOOL_REJECTED', workType: 1, icon: 'bull', deepLink: '{0}://fdt/me/editprofile/editschool'},
  SCHOOL_REMIND: {id: 71, str: 'SCHOOL_REMIND', workType: 1, icon: 'bull', deepLink: '{0}://fdt/me/editprofile/editschool'},
  SCHOOL_EXPIRED: {id: 72, str: 'SCHOOL_EXPIRED', workType: 1, icon: 'bull', deepLink: '{0}://fdt/me/editprofile/editschool'},
};

module.exports = htmlMsgKey;
